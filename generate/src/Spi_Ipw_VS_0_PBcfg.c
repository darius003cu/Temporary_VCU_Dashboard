...
#include "Spi_MemMap.h"
/* External device configuration for SpiExternalDevice_Display */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_Display_VS_0 =
{
    SPI_OVER_LPSPI, /* IpType */
    0U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Display_Instance_0_VS_0, /* Lpspi IP Config */
...
{
    /* SpiExternalDevice_Display */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_Display_VS_0
    }
};
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_0_VS_0 =
{
        ...
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_0_VS_0 /* Lpspi IpConfig */
            #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
