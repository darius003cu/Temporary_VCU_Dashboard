...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Display Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_Display_Instance_0_VS_0 =
{
    0U,  /* Instance */
        (uint32)(LPSPI_CCR_SCKPCS(47U) | LPSPI_CCR_PCSSCK(47U) | LPSPI_CCR_SCKDIV(3U) | LPSPI_CCR_DBT(46U)), /* ccr */
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_0_VS_0 =
{
    0U,  /* Instance */
     /* CR */
    (uint32)0,
